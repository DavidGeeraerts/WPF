...
IF EXIST %LOG_LOCATION%\%PROCESS_COMPLETE_FILE% IF %DOMAIN_USER_STATUS% EQU 1 IF DEFINED LOG_SHIPPING_LOCATION COPY /Y "%LOG_LOCATION%\%LOG_FILE%" "%LOG_SHIPPING_LOCATION%"
